<?php
    ...
    if (isset($_SESSION["user_id"])) {
        ...
        $newsql = $sql->prepare("SELECT * FROM users WHERE id = ?");
        $newsql->bind_param("i", $_SESSION["user_id"]);
        $newsql->execute();
        $res = $newsql->get_result();
...
<body>
    <div>
        <nav class="navbar">
            ...
            <div class="nav-auth">
                <a href="./both_login.php" class="login">Log In</a>
                <a href="./both_register.php" class="register">Register</a>
            </div>
        </nav>
